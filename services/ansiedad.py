...
def get_ansiedades():
    ...
    data = {"message": "Lista generada con éxito", "status": 200, "ansiedades": result}
...
def update(id_ansiedad):
    ...
    if not ansiedad:
        data = {"message": "No se encontró la ansiedad", "status": 404}
...
def delete(id_ansiedad):
    ...
    data = {"message": "Ansiedad eliminada con éxito", "status": 200}
